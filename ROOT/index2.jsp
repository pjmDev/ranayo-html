   ...
   <head>
	...
	<script type="text/javascript" src="/lib/js/lightslider.js"></script> 
	   <style type="text/css">
		...
		.ramainimg{background-image: url('/data/main/mainimg01.jpg');no-repeat; background-size:100% 100%; alt="mainimg";}
...
<!--------------------------------------------------------------------scrollmenu end---------------------------------------------------------------->
       ...
       <div style="width:1100px; height:100px; margin:0 auto;"><!--top -->
		 ...
		 <div class="ramainimg" style="width:100%; height:850px;" > </div> <!--main img -->
		<!--
		<div style="width:1100px; height:100%; margin:0 auto; text-align:center;">
			<iframe width="1000px" height="574px" src="https://www.youtube.com/embed/baf9yxeKuZk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
		-->
...
<div class="demo" style="margin:0 auto;"> 
 ...
 <ul name="content-slider" class="content-slider">
                <li>
                    <h3><img src="/data/main/scroll1.jpg" width="183px" height="190px;"></h3>
                </li>
                <li>
                    <h3><img src="/data/main/scroll2.jpg" width="183px" height="190px"></h3>
                </li>
                <li>
                    <h3><img src="/data/main/scroll3.jpg" width="183px" height="190px"></h3>
                </li>
                <li>
                    <h3><img src="/data/main/scroll4.jpg" width="183px" height="190px"></h3>
                </li>
                <li>
                    <h3><img src="/data/main/scroll5.jpg" width="183px" height="190px"></h3>
                </li>
                <li>
                    <h3><img src="/data/main/scroll3.jpg" width="183px" height="190px"></h3>
                </li>
