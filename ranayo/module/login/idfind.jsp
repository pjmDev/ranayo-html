...
<div style="width:100%; height:90px;"> </div> <!--blank1 -->
	     ...
	     <form action="#"method="post"><!------------------------------------------------------------------------------------------------------------>
	        <div class="join_page" style="width:430px; height:350px; margin:0 auto; text-align: center;">  <!--join page-->	 
	            아이디 찾기
			   <input  type="text" name="id" value="이메일 입력"onblur="checkField(this)" onfocus="clearField(this)" 
				...
				<input  type="image" src="/data/pub/transfer.png" 
    			   ...
    			   <a href="/module/login/passfind.jsp">
				   <img src="/data/module/idfind/passbar.png" 
		             width="430px" height="65px" alt="비밀번호찾기"> </a>
